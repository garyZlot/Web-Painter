...
function Rectangle (x, y, width, height) {
    ...
    Object.defineProperty(this, "size", {get : function(){return new Point(this.width, this.height);},
                                        set : function(point){this.inflatePoint(point);}});                                         
    Object.defineProperty(this, "top", {get : function(){return this.y;},
                                    set : function(value){this.y = top;}});
    Object.defineProperty(this, "bottom", {get : function(){return this.y + this.height;},
                                        set : function(value){this.height = value - this.y;}});
    Object.defineProperty(this, "left", {get : function(){return this.x;},
                                        set : function(value){this.x = value;}});                               
    Object.defineProperty(this, "right", {get : function(){return this.x + this.height;},
                                         set : function(value){this.width = value - this.x;}}); 
    Object.defineProperty(this, "topLeft", {get : function(){return new Point(this.left, this.top);},
                                        set : function(point){this.left = point.x; this.top = point.y;}});                                         
    Object.defineProperty(this, "topRight", {get : function(){return new Point(this.right, this.top);},
                                         set : function(point){this.right = point.x; this.top = point.y;}});                                           
    Object.defineProperty(this, "bottomLeft", {get : function(){return new Point(this.left, this.bottom);},
                                         set : function(point){this.left = point.x; this.bottom = point.y;}});                                         
    Object.defineProperty(this, "bottomRight", {get : function(){return new Point(this.right, this.bottom);},
                                         set : function(point){this.right = point.x; this.bottom = point.y;}});
